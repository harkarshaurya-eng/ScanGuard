...
from recon_ai.ai.agent import ReconAgent
from recon_ai.config import AppSettings, ensure_env_file, ensure_user_prompt
from recon_ai.constants import APP_NAME, BASELINE_TOOLS
from recon_ai.logging_config import configure_logging
from recon_ai.mcp.executor import ToolExecutionError, ToolExecutor
...
from recon_ai.storage.workspace import ProjectWorkspace, create_workspace, discover_projects, load_workspace
from recon_ai.utils.files import ensure_dir
...
async def run_agent_chat(workspace: ProjectWorkspace, settings: AppSettings, auto_safe: bool) -> None:
    ...
    try:
        while True:
            user_input = Prompt.ask("[bold cyan]recon-ai[/bold cyan]")
